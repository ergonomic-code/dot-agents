...
Baseline так же загружает корневой индекс контекста, который классифицирует фактическую запрошенную и запланированную работу и загружает все подходящие тематические индексы.
