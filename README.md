...
После разрешения задачи модуль передаёт выбранной роли конкретные привязки артефактов, а роль вызывает generic-скиллы с явными входами и путями результатов.
