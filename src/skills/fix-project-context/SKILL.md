...
description: Analyze a project-context problem from mandatory `codex session id`, `problem`, and `target behavior`; load `project-context-engineer`; propose `minimal`, `systemic`, and `optimal` fixes; wait for explicit choice; then implement it.
---
