...
- database-backed reads, query-mapped types, ordering, filtering, pagination, limiting, deduplication, or existence checks: `../conventions/db-query-shaping.md` and `../conventions/db-read-model-boundaries.md`;
