...
- `Feature` ends with the evidence-backed SUT reference in parentheses, or is a permitted provisional `Feature` for an explicitly planned new SUT.
...
- Overlapping rules and examples are merged.
