...
- `./test-doubles.md` before choosing test dependencies.
...
- During the final self-check for test changes, apply `./test-implementation-checklist.md` to the final diff and fix every failed applicable item.
