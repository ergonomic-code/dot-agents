...
- Load this file when a task brief, blueprint, or refactoring task must align with a named architecture source such as `ergo-arch.adoc`.
...
- In task briefs, use this summary to translate architecture goals into explicit constraints and acceptance criteria.
