...
- Load this file when supplied requirements, a blueprint, or a refactoring request must align with a named architecture source such as `ergo-arch.adoc`.
...
- In requirements artifacts, use this summary to translate architecture goals into explicit constraints and acceptance criteria.
