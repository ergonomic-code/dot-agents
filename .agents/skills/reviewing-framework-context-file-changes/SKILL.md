...
- the baseline invokes task resolution once for the initial request without implementing its algorithm
- only the task resolver detects and selects an active task
